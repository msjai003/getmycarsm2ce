...
namespace Gmc\Quote\Model\QuoteGraphQl\Resolver;
...
use Gmc\Quote\Preference\Model\Cart\Data\CartItemFactory;
use Magento\Quote\Model\QuoteMutexInterface;
use Magento\QuoteGraphQl\Model\Cart\GetCartForUser;
use Magento\Quote\Model\Cart\Data\Error;
use Magento\QuoteGraphQl\Model\CartItem\PrecursorInterface;
use Magento\QuoteGraphQl\Model\Resolver\AddProductsToCart as QuoteGraphQlAddProductsToCart;
 ...
 * @inheritdoc
 */
class AddProductsToCart extends QuoteGraphQlAddProductsToCart implements ResolverInterface
{
    /**
     * @var GetCartForUser
     */
    ...
    public function resolve(Field $field, $context, ResolveInfo $info, array $value = null, array $args = null)
    {
        ...
        if (
            empty($args['cartItems']) || !is_array($args['cartItems'])
        ) {
