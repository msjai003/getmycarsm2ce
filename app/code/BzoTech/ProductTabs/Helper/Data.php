...
namespace BzoTech\ProductTabs\Helper;
...
use BzoTech\ProductTabs\Block\ProductTabs;
...
class Data extends AbstractHelper
{
    ...
    public function __construct(
        ...
        \BzoTech\ProductTabs\Block\ProductTabs $block
    )
    {
    ...
    private function getProductImages($product, $_config, $prefix = 'img')
    {
        ...
        $_placeholder = ($placeholder != '' && strpos($placeholder, 'http') !== false) ? $placeholder : $this->_block->getViewFileUrl('BzoTech_ProductTabs::images/nophoto.jpg');
    ...
    public function _getImageThumbnail($image)
    {
        ...
        $placeholder = $this->_block->getViewFileUrl('BzoTech_ProductTabs::images/nophoto.jpg');
