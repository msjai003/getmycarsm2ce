...
namespace BzoTech\Megashop\Model\Import;
...
class Cms
{
    ...
    )
    {
        ...
        $this->_importPath             = BP . '/app/code/BzoTech/Megashop/etc/import/';
    ...
    public function importCms($type)
    {
        ...
        try {
            ...
            if ($this->_scopeConfig->getValue("megashop/theme_install/overwrite_" . $type)) {
                $overwrite = true;
            }
