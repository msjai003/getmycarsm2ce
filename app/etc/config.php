...
return [
    'modules' => [
        ...
        'BzoTech_AjaxCart' => 1,
        'BzoTech_AjaxLayeredNavigation' => 1,
        'BzoTech_AjaxSearch' => 1,
        'BzoTech_Buy' => 1,
        'BzoTech_Categories' => 1,
        'BzoTech_Core' => 1,
        'BzoTech_Megamenu' => 1,
        'BzoTech_Megashop' => 1,
        'BzoTech_PopupContent' => 1,
        'BzoTech_PopupLogin' => 1,
        'BzoTech_ProductTabs' => 1,
        'BzoTech_ThemeCore' => 1,
        'BzoTech_WidgetProducts' => 1,
        'ET_Base' => 0,
        'ET_Theme' => 0,
        'Gmc_Catalog' => 1,
        'Gmc_LoginAuth' => 1,
        'Gmc_MobileAuth' => 1,
        'Gmc_PartnerContribution' => 1,
        'Gmc_Phonepe' => 1,
        'Gmc_Quote' => 1,
        'Gmc_Sales' => 1,
        'Gmc_Sms' => 1,
